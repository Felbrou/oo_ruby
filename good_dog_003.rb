...
class GoodDog
	def initialize(name)
		@name = name # the @ is called instance variable, it is a variable that exists as long as long as the object instance exists
	end              # and that is one of the ways we tie data to objects
end
